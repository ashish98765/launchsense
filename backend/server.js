// LaunchSense Backend — Phase-4 Batch-3 (SLA + Final Hardening)
...
v1.post("/sdk/decision", apiAuth, async (req, res) => {
  try {
    ...
    const metrics = {
      ...
      confidence:
        Math.round((1 - Math.abs(0.5 - risk)) * 100) / 100
    };
    ...
    // NOTE: SQL insert intentionally skipped for now
